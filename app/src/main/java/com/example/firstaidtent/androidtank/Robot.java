...
public class Robot {
    ...
    private final int JUMPHEIGHT = 200;
    private final int MOVESPEED = 5;
    private final int BGSPEED = 0;
    ...
    static Rect rect = new Rect(0, 0, 0, 0);
    static Rect rect2 = new Rect(0, 0, 0, 0);
    static Rect rect3 = new Rect(0, 0, 0, 0);
    static Rect rect4 = new Rect(0, 0, 0, 0);
    static Rect yellowRed = new Rect(0, 0, 0, 0);

    static Rect footleft = new Rect(0,0,0,0);
    static Rect footright = new Rect(0,0,0,0);
...
//            bg1.setSpeed(-MOVESPEED / 5);
//            bg2.setSpeed(-MOVESPEED / 5);
//        }

        centerX += speedX;

        bg1.setSpeedX(-BGSPEED);
        bg2.setSpeedX(-BGSPEED);
