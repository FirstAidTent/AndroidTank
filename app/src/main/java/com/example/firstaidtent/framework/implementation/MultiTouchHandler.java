...
import com.example.firstaidtent.androidtank.GameScreen;
...
//            int pointerCount = event.getPointerCount();
            ...
            for (int i = 0; i < MAX_TOUCHPOINTS; i++) {
                ...
                if (i == 0) {
                    GameScreen.debugString = "id: " + pointerId + ", a: " + action + ", x: " + (int)(event.getX(i) * scaleX)
                            + ", y: " + (int)(event.getY(i) * scaleY);
                } else if (i == 1) {
                    GameScreen.debugString2 = "id: " + pointerId + ", a: " + action + ", x: " + (int)(event.getX(i) * scaleX)
                            + ", y: " + (int)(event.getY(i) * scaleY);
                } else if (i == 2) {
                    GameScreen.debugString3 = "id: " + pointerId + ", a: " + action + ", x: " + (int)(event.getX(i) * scaleX)
                            + ", y: " + (int)(event.getY(i) * scaleY);
                }
