...
public class AndroidGraphics implements Graphics {
    ...
    // Finds srcX, srcY on the srcImg and draws out a rectangle with width and height and
    // gets the image from the drawn rectangle and puts the image on x and y.
